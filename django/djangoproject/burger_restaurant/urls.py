...
urlpatterns = [
    ...
    path('customer_home/<str:primary>/', views.home, name="customer_home"),
    # path('customer/', views.customer, name = "customer" ),
    path('add_customer/', views.createCustomer, name="add_customer"),
    path('place_order/<str:primary>/', views.placeOrder, name="place_order"),
    path('show_order/<str:primary>/', views.showOrder, name= "show_order"),
    path('order_history/<str:primary>/', views.orderHistory, name= "order_history"),
